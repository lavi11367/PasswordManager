(function(window, document, $, undefined) {
    ...
    var axilInit = {
        ...
        methods: function(e) {
            ...
            axilInit.sideOffcanvasToggle('.Edit', '#cart-dropdown');
            axilInit.sideOffcanvasToggle('.Edit_Notification', '#Notification');
            ...
            axilInit.sideOffcanvasToggle('.Add', '#header-search-modal');
                ...
                success: function(dataResult){
                  ...
                  if(dataResult.statusCode==200){
                    ...
                    $('#fupForm').find('input').val('');
                        document.getElementById("h5").style.marginBottom = "10px";
                    $("#success").show();
